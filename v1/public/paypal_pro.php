...
if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) {
	header("Location:success.php");//exit('Direct Payment Completed Successfully: '.print_r($httpParsedResponseAr, true));
} else  {
	header("Location:fail.php"); //exit('DoDirectPayment failed: ' . print_r($httpParsedResponseAr, true));
}
